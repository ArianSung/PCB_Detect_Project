#!/usr/bin/env python3
"""
12월 5일, 8일 데이터 재생성 (모든 summary 테이블 포함)
"""
...
def main():
    ...
    # 12월 5일
    print("\n[2025-12-05]")
    target_count_5 = random.randint(850, 950)
    defect_rate_5 = random.uniform(12, 28)
    print(f"  - 목표: {target_count_5}개, 불량률: {defect_rate_5:.1f}%")

    inspections_5 = generate_inspection_data(datetime(2025, 12, 5), target_count_5, defect_rate_5)
    insert_inspections(connection, inspections_5)
    print(f"  ✓ 삽입 완료: {len(inspections_5)}개")

    # 12월 8일
    print("\n[2025-12-08]")
    target_count_8 = random.randint(850, 950)
    defect_rate_8 = random.uniform(12, 28)
    print(f"  - 목표: {target_count_8}개, 불량률: {defect_rate_8:.1f}%")

    inspections_8 = generate_inspection_data(datetime(2025, 12, 8), target_count_8, defect_rate_8)
    insert_inspections(connection, inspections_8)
    print(f"  ✓ 삽입 완료: {len(inspections_8)}개")
