...
- 라즈베리파이 1 (USB 시리얼 통신)
- 9개 박스 슬롯 (3 카테고리 × 3 슬롯, 수평 배치) + DISCARD 위치
...
// NORMAL 박스 (슬롯 0-2, 수평 3슬롯)
const Coordinate NORMAL_SLOTS[3] = {
  {88, 115, 85, 90, 90},  // 슬롯 0 (좌측)
  {92, 115, 84, 90, 90},  // 슬롯 1 (중앙)
  {96, 115, 83, 90, 90}   // 슬롯 2 (우측)
};

// COMPONENT_DEFECT 박스 (슬롯 0-2, 수평 3슬롯)
const Coordinate COMPONENT_DEFECT_SLOTS[3] = {
  {88, 105, 86, 90, 90},  // 슬롯 0
  {92, 105, 85, 90, 90},  // 슬롯 1
  {96, 105, 84, 90, 90}   // 슬롯 2
};

// SOLDER_DEFECT 박스 (슬롯 0-2, 수평 3슬롯)
const Coordinate SOLDER_DEFECT_SLOTS[3] = {
  {88, 95, 87, 90, 90},   // 슬롯 0
  {92, 95, 86, 90, 90},   // 슬롯 1
  {96, 95, 85, 90, 90}    // 슬롯 2
};
