...
[![YOLOv11m](https://img.shields.io/badge/YOLO-v11m-00FFFF.svg)](https://github.com/ultralytics/ultralytics)
...
본 프로젝트는 **YOLO v11m 객체 탐지**와 **이상 탐지(Anomaly Detection)** 기술을 결합한 하이브리드 딥러닝 시스템으로, PCB(인쇄회로기판) 제조 공정에서 발생하는 다양한 불량을 실시간으로 검출하고 자동 분류합니다.
...
- 🤖 **AI 하이브리드 모델**: YOLO v11m + 이상 탐지 결과 융합
